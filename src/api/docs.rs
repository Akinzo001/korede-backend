...
use crate::api::{
    ...
    hospitals::{
        ...
        HospitalCaseBillingItemResponse, HospitalCaseDocumentResponse, HospitalCaseResponse,
        HospitalDocumentResponse, HospitalDocumentsResponse, HospitalPatientDeclarationResponse,
        HospitalPatientLookupDeclarationResponse, HospitalPatientLookupPatientResponse,
        HospitalPatientLookupResponse, HospitalResponse, HospitalSummaryResponse,
